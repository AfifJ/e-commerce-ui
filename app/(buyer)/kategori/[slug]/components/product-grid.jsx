...
export default function ProductGrid({ filteredProducts, isLoading, viewMode, handleFilterChange }) {
    ...
    return (
      <div className="container mx-auto px-4 py-12">
        <div className="text-center">
          ...
          <Button onClick={() => handleFilterChange('clearAll', '')}>Hapus Filter</Button>
        </div>
      </div>
    );
  }
